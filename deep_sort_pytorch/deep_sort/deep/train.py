...
if args.resume:
    assert os.path.isfile(
        "https://portfolio94.nyc3.digitaloceanspaces.com/detect-now-ai/checkpoint/ckpt.t7"), "Error: no checkpoint file found!"
    print('Loading from checkpoint/ckpt.t7')
    checkpoint = torch.load(
        "https://portfolio94.nyc3.digitaloceanspaces.com/detect-now-ai/checkpoint/ckpt.t7")
