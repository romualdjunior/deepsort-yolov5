...
def main():
    ...
    if input_source == "Local video":
        ...
        if st.sidebar.button("Start tracking"):
            ...
            detect(weights="yolov5s_people.pt", source="upload/input."+video_extention, stframe=stframe, kpi1_text=kpi1_text, kpi2_text=kpi2_text, kpi3_text=kpi3_text, js1_text=js1_text, js2_text=js2_text, js3_text=js3_text, conf_thres=float(conf_thres), device='0', nosave=nosave, display_labels=display_labels,
    ...
    if input_source == "Webcam":
        ...
        if st.sidebar.button("Start tracking"):
            ...
            detect(weights="yolov5s_people.pt", source='0', stframe=stframe, kpi1_text=kpi1_text, kpi2_text=kpi2_text, kpi3_text=kpi3_text, js1_text=js1_text, js2_text=js2_text, js3_text=js3_text, conf_thres=float(conf_thres), device='0', nosave=nosave, display_labels=display_labels,
                   conf_thres_drift=float(conf_thres_drift), save_poor_frame__=save_poor_frame__, inf_ov_1_text=inf_ov_1_text, inf_ov_2_text=inf_ov_2_text, inf_ov_3_text=inf_ov_3_text, inf_ov_4_text=inf_ov_4_text, fps_warn=fps_warn, fps_drop_warn_thresh=float(fps_drop_warn_thresh))
    ...
    if input_source == "RTSP":
        ...
        rtsp_input = st.sidebar.text_input(
            "Video Link or Camera IP Address", "https://portfolio94.nyc3.digitaloceanspaces.com/people-counter/video/cctv.mp4")
        if st.sidebar.button("Start tracking"):
            ...
            detect(weights="yolov5s_people.pt", source=rtsp_input, stframe=stframe, kpi1_text=kpi1_text, kpi2_text=kpi2_text, kpi3_text=kpi3_text, js1_text=js1_text, js2_text=js2_text, js3_text=js3_text, conf_thres=float(conf_thres), device='0', nosave=nosave, display_labels=display_labels,
                   conf_thres_drift=float(conf_thres_drift), save_poor_frame__=save_poor_frame__, inf_ov_1_text=inf_ov_1_text, inf_ov_2_text=inf_ov_2_text, inf_ov_3_text=inf_ov_3_text, inf_ov_4_text=inf_ov_4_text, fps_warn=fps_warn, fps_drop_warn_thresh=float(fps_drop_warn_thresh))
